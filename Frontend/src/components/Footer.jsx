    ...
    <footer className="bg-gray-900 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="col-span-1">
            <span className="text-xl font-bold text-indigo-400 tracking-wide">
              Local Service
            </span>
            ...
            <div className="flex space-x-3 mt-5">
              {socials.map((s) => (
                <a
                  ...
                  href={s.href}
                  aria-label={s.label}
                  className="p-2 rounded-full bg-gray-800 text-gray-400 hover:bg-indigo-600 hover:text-white transition-colors duration-200"
                >
                  {s.icon}
                </a>
              ))}
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-gray-500">
          <p>&copy; 2026 Local Service Management System. All rights reserved.</p>
